...
function VectexIn:ctor(pos, color, tex, normal)
	self.pos = pos
	self.color = color
	self.tex = tex
	self.normal = normal
...
VectexOut = class()
function VectexOut:ctor(pos_world, pos_proj, tex, color, normal, oneDivZ)
...
function vectexout_lerp(v1, v2, t)
	return VectexOut.new(
